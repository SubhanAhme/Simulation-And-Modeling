...
def app():
    st.title("This is MMC Simulation")
    ...
    if st.button('Generate Plot'):
        df,s_no,arrival,service,WT,RT,TA,server_info,avg_interarrival,avg_service,avg_TA,avg_WT,avg_RT,Servers=MMC(lembda,meu,server_no)
        st.write(df)
