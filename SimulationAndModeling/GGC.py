...
def app():
    st.title("This is GGC Simulation")
    ...
    if st.button("Generate Plot"):
        df,s_no,arrival,service,WT,RT,TA,server_info,avg_interarrival,avg_service,avg_TA,avg_WT,avg_RT,Servers=GGC(meu,a,d,p,sigma,server_no)
        st.write(df)
